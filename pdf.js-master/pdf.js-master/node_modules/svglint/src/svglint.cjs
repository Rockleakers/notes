...
function parseFile(file) {
    ...
    return new Promise((resolve, reject) => {
        ...
        fs__default["default"].readFile(filePath, 'utf8', (error, data) => {
            if (error) {
                return reject(error);
            }
...
class Linting extends node_events.EventEmitter {
    ...
    constructor(file, ast, rules) {
        ...
        this.name = file ? path__default["default"].relative(process__default["default"].cwd(), file) : 'API';
...
async function ruleLoader(ruleName) {
    ...
    const module = await (isExternal
        ? (function (t) { return Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require(t)); }); })(`svglint-plugin-${ruleName}`)
